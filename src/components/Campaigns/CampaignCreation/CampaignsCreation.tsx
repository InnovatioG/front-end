...
import { CHEVRON_RIGHT_ICON } from '@/utils/constants/images';
...
import { toJson, useAppStore, useWalletStore } from 'smart-db';
...
const CampaignsCreation: React.FC<CampaignsCreationProps> = (props) => {
    ...
    //--------------------------------------
    const { showDebug, protocol } = useGeneralStore();
    //--------------------------------------
    ...
    const handleCreateCampaign = async () => {
        ...
        const handleSaveCampaign = (data?: Record<string, any>) =>
            serviceSaveCampaign(appStore, walletStore, openModal, protocol, propsCampaignIdStoreSafe.campaign, data, onFinish);
