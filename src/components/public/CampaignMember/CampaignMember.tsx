            ...
            <div>
                ...
                <div className={styles.listContainer}>
                    <table border="1">
                        <thead>
                          <tr>
                            <th key="0">campaignId</th><th key="1">editor</th><th key="2">walletId</th><th key="3">rol</th><th key="4">description</th><th key="5">website</th><th key="6">instagram</th><th key="7">twitter</th><th key="8">discord</th><th key="9">facebook</th><th key="10">createAt</th><th key="11">updateAt</th>
                          </tr>
                        </thead>
                        <tbody>
                            {list?.map((item, index) => (
                              <tr key={index}>
                                <td key="0">{item.campaignId }</td><td key="1">{item.editor }</td><td key="2">{item.walletId }</td><td key="3">{item.rol }</td><td key="4">{item.description }</td><td key="5">{item.website }</td><td key="6">{item.instagram }</td><td key="7">{item.twitter }</td><td key="8">{item.discord }</td><td key="9">{item.facebook }</td><td key="10">{item.createAt }</td><td key="11">{item.updateAt }</td>
                                <td>
