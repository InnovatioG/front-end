            ...
            <div>
                ...
                <div className={styles.listContainer}>
                    <table border="1">
                        <thead>
                          <tr>
                            <th key="0">campaignId</th><th key="1">submissionStatusId</th><th key="2">submittedByWalletId</th><th key="3">revisedByWalletId</th><th key="4">approvedJustification</th><th key="5">rejectedJustification</th><th key="6">createAt</th><th key="7">updateAt</th>
                          </tr>
                        </thead>
                        <tbody>
                            {list?.map((item, index) => (
                              <tr key={index}>
                                <td key="0">{item.campaignId }</td><td key="1">{item.submissionStatusId }</td><td key="2">{item.submittedByWalletId }</td><td key="3">{item.revisedByWalletId }</td><td key="4">{item.approvedJustification }</td><td key="5">{item.rejectedJustification }</td><td key="6">{item.createAt }</td><td key="7">{item.updateAt }</td>
                                <td>
