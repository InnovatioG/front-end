            ...
            <div>
                ...
                <form>
                    <div>
                        ...
                        <input type="text" value={newItem.pdProtocolVersion || ''} onChange={(e) => handleInputChange('pdProtocolVersion', e.target.value)} />
                    </div>
                    <div></div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" value={newItem.pdTokenAdminPolicy_CS || ''} onChange={(e) => handleInputChange('pdTokenAdminPolicy_CS', e.target.value)} />
                    </div>
                    <div></div>
                    <div>
                        <label>pdMinADA: </label>
                        <input type="text" value={newItem.pdMinADA || ''} onChange={(e) => handleInputChange('pdMinADA', e.target.value)} />
                    </div>
                    <div></div>
                    <div>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={newItem.createdAt ? new Date(newItem.createdAt).toISOString() : ''}
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={newItem.updatedAt ? new Date(newItem.updatedAt).toISOString() : ''}
            ...
            <div>
                ...
                <div className={styles.listContainer}>
                    <table>
                        <thead>
                            <tr>
                                <th key="0">pdProtocolVersion</th>
                                <th key="1">pdAdmins</th>
                                <th key="2">pdTokenAdminPolicy_CS</th>
                                <th key="3">pdMinADA</th>
                                <th key="4">contracts</th>
                                <th key="5">createdAt</th>
                                <th key="6">updatedAt</th>
                            </tr>
                        </thead>
                        <tbody>
                            {list?.map((item, index) => (
                                <tr key={index}>
                                    <td key="0">{item.pdProtocolVersion}</td>
                                    <td key="1">{item.pdAdmins}</td>
                                    <td key="2">{item.pdTokenAdminPolicy_CS}</td>
                                    <td key="3">{item.pdMinADA}</td>
                                    <td key="4">{item.contracts}</td>
                                    <td key="5">{item.createdAt.toISOString()}</td>
                                    <td key="6">{item.updatedAt?.toISOString()}</td>
                                    <td>
