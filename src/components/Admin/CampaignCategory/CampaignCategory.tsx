...
export default function CampaignCategory() {
    ...
    const renderList = () => (
        <div>
            ...
            {list.length === 0 ? (
                <p>No Campaign Categories found.</p>
            ) : (
                <table>
                    <thead>
                        <tr>
    ...
    const renderForm = (
        item: Partial<CampaignCategoryEntity>,
        setItem: Dispatch<SetStateAction<Partial<CampaignCategoryEntity>>> | Dispatch<SetStateAction<Partial<CampaignCategoryEntity> | null>>
    ) => (
