...
export default function MilestoneStatus() {
    ...
    const renderForm = (
        item: Partial<MilestoneStatusEntity>,
        setItem: Dispatch<SetStateAction<Partial<MilestoneStatusEntity>>> | Dispatch<SetStateAction<Partial<MilestoneStatusEntity> | null>>
    ) => (
