import { CHART, COLABORATORS, CONTRIBUITED, LAUNCHED, USER, USERS } from '@/utils/images';
        ...
        <div className={styles.cardSection}>
            <div className={styles.card}>
                ...
                <div className={styles.pictureContainer}>
                    <Image layout="fill" objectFit="contain" src={LAUNCHED} alt="launched-campaings" className={styles.imageCard} objectPosition={'bottom right'} />
                </div>
            </div>
            <div className={styles.card}>
                <svg width="18" height="18" className={styles.icon}>
