...
interface CampaignsManageEditPageProps {
    // Define props here
}

const CampaignsManageEditPage: React.FC<CampaignsManageEditPageProps> = (props) => {
        ...
        return (
            <div className={styles.campaignSection}>
                <div className={styles.mainSection}>
                    <h2 className={styles.title}>In order to continue with the edit process you must connect wallet in Admin Mode</h2>
...
export default CampaignsManageEditPage;
